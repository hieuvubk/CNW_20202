...
//import com.company.pm.interactionservice.domain.assembler.PostRepresentationModelAssembler;
...
//                        .flatMap(user -> {
//                            Flux<Post> postFlux = postService.getPostsByUser(user.getId());
//
...
//                if (principal instanceof AbstractAuthenticationToken) {
//                    return userService.getUserFromAuthentication((AbstractAuthenticationToken) principal)
//                        .flatMap(user -> postService.getPostByUser(user.getId(), postId)
...
//    public Mono<ResponseEntity<EntityModel<Post>>> createPost(
...
//                if (principal instanceof AbstractAuthenticationToken) {
//                    return userService.getUserFromAuthentication((AbstractAuthenticationToken) principal)
//                        .flatMap(user -> postService.createPostByUser(user.getId(), postDTO)
...
//                if (principal instanceof AbstractAuthenticationToken) {
//                    return userService.getUserFromAuthentication((AbstractAuthenticationToken) principal)
//                        .flatMap(user -> postService.updatePostByUser(user.getId(), postId, postDTO)
//                            .flatMap(post -> assembler
//                                .toModel(post, exchange)
//                                .map(model -> ResponseEntity
//                                    .ok()
...
//                if (principal instanceof AbstractAuthenticationToken) {
//                    return userService.getUserFromAuthentication((AbstractAuthenticationToken) principal)
//                        .flatMap(user -> postService.deletePostByUser(user.getId(), postId)
