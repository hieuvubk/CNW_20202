...
/**
 * Performance test for the PersonalProfile entity.
 */
class PersonalProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PersonalProfile entity")
        ...
        .pause(10)
        .repeat(1) {
            exec(http("Get all personalProfiles")
            .get("/api/v1/profile")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
